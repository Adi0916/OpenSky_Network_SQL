...
### Projekt semestralny | Przedmiot: Wprowadzenie do baz danych
...
git clone https://github.com/Adi0916/WDBD_Projekt_Semestralny.git
...
## Stos technologiczny
* **Baza danych:** PostgreSQL / MySQL (Relacyjna struktura danych)
...
* **Wizualizacja:** Grafana / PowerBI / Streamlit (niepotrzebne skreślić)
* **Biblioteki Python:** `requests`, `psycopg2` / `sqlalchemy`, `pandas`, `schedule`
```

## Model danych
Struktura bazy danych została zaprojektowana tak, aby zapewnić integralność danych i umożliwić analizę historyczną.
